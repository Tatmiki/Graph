    ...
    while(opc != 13)
    {
        ...
        switch(opc)
        {
            ...
            case 2:
                ...
                printf("\n~> Informe o arquivo: ");
                scanf(" %s", arquivo);
                G = lg_makeGraphFromFile(arquivo);
                if(G == NULL)
                    printf("Falha na criação do grafo\n");
                else    
                    printf("Criacao do grafo concluida!\n");
                break;
            case 3:
                if(G != NULL && lg_getNumOfVertexes(G) > 1) 
                {
                    ...
                    for(i = 0; i < quant; i++)
                    {
                        ...
                        if(lg_insertEdge(G,vertece1, vertece2))
                ...
                break;
            case 4:
                if((G != NULL && lg_getNumOfVertexes(G) > 1) && lg_getNumOfEdges(G) > 0) //Adicionar G->V
                {
                ...
                else if(lg_getNumOfVertexes(G) < 2 || lg_getNumOfEdges(G) < 1)
                    printf("A quantidade de vertices deve ser maior que 1 e\na quantidade de aretas deve ser maior que 1 para se efetuar uma remocao de aresta!\n");
                else
                    printf("Grafo nao criado...\n");               
                break;
            case 5:
            ...
            case 7:
                if(G != NULL)
                {
                    ...
                    scanf("%u",&vertece1);
                    if(lg_iterativeDfs(G,vertece1,arquivo))
                        printf("Arquivo de saída criado com sucesso!\n");
                    else    
                        printf("Falha na criação do arquivo...\n");
                }
            ...
            case 8:
                if(G != NULL)
                {
                    ...
                    scanf("%u %u", &vertece1, &vertece2);
                    distancia = lg_distance(G, vertece1, vertece2);
                    if(distancia == -1)
            ...
            case 9:
                if(G != NULL)
                {
                    ...
                    scanf("%d", &vertece);
                    exentricidade = lg_vertexEccentricity(G, vertece);
                    if(exentricidade == -1)
            ...
            case 10:
                if(G != NULL)
                {
                    diametroAbs = lg_absoluteDiameter(G);
                    if(diametroAbs == -1)
            ...
            case 11:
                if(G != NULL)
                {
                    diametroApox = lg_aprroximateDiameter(G);
                    if(diametroApox == -1)
