    ...
    while(opc != 13)
    {
        ...
        switch(opc)
        {
            ...
            case 2:
                ...
                printf("\n~> Informe o arquivo: ");
                scanf(" %s", caminho_arq);
                G = lg_makeGraphFromFile(caminho_arq);
                if(G == NULL)
                    printf("Falha na criação do grafo\n");
                else    
                    printf("Criacao do grafo concluida!\n");
            ...
            case 5:
                if(G != NULL)
                {
                    ...
                    scanf(" %s", caminho_arq);
                    if(lg_outputFile(G,caminho_arq))
            ...
            case 7:
                if(G != NULL)
                {
                    ...
                    scanf("%u",&u);
                    if(lg_recursiveDfs(G,u,caminho_arq))
                        printf("Arquivo de saída criado com sucesso!\n");
                    else    
                        printf("Falha na criação do arquivo...\n");
                }
            ...
            case 9:
                if(G != NULL)
                {
                    ...
                    scanf("%d", &v);
                    exentricidade = lg_vertexEccentricity(G, v);
                    if(exentricidade == -1)
            ...
            case 10:
                if(G != NULL)
                {
                    diametro = lg_absoluteDiameter(G);
                    if(diametro == -1)
            ...
            case 11:
                if(G != NULL)
                {
                    diametro = lg_aprroximateDiameter(G);
                    if(diametro == -1)
